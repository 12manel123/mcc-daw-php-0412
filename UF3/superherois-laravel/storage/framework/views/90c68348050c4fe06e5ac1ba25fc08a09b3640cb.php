...
<form action="<?php echo e(route('mysuperheroes.canviarpoders',[$superhero->id,$powers->id])); ?>" method="POST">
	<?php echo csrf_field(); ?>

	<td><input type="number" name="nivell" value="<?php echo e($powers->level->amount); ?>"></td>

	<td><input type="submit" value="Canviar" > </form>| <a href="<?php echo e(route('mysuperheroes.eliminarpoders',[$superhero->id,$powers->id])); ?>">Eliminar</a></td>
...
<div id="poder">
<h3>Llista poders</h3>
<form method="POST" action="<?php echo e(route('mysuperheroes.afegirpoder',$superhero->id)); ?>">
	<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/usuari/projectesLaravel/superherois-laravel/resources/views/mysuperheroes/poders.blade.php ENDPATH**/ ?>